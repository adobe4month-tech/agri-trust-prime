            ...
            >
              <div className="relative aspect-square rounded-xl overflow-hidden shadow-card group-hover:shadow-elevated transition-all duration-300 group-hover:-translate-y-1 mb-2">
                ...
                <div className="absolute inset-x-0 bottom-0 p-2.5">
                  <p className="text-sm font-bold text-primary-foreground drop-shadow-lg">{crop.name}</p>
                  <p className="text-[10px] text-primary-foreground/70 font-medium">{crop.nameUrdu}</p>
                </div>
              ...
              <p className="text-[10px] text-muted-foreground font-medium">{crop.productCount} Products</p>
            </Link>
          ))}
        </div>
      </div>
